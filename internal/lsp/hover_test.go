...
func TestHover(t *testing.T) {
	...
	tests := []hoverTestCase{
		...
		// Documentation link tests (celbyexample.com)
		{name: "link_logical_and", file: "testdata/hover/logical.cel", line: 0, char: 3, contains: "celbyexample.com/logical-operators/#and", desc: "'&&' links to celbyexample.com"},
		{name: "link_logical_or", file: "testdata/hover/logical.cel", line: 0, char: 9, contains: "celbyexample.com/logical-operators/#or", desc: "'||' links to celbyexample.com"},
		{name: "link_logical_not", file: "testdata/hover/logical.cel", line: 0, char: 0, contains: "celbyexample.com/logical-operators/#not", desc: "'!' links to celbyexample.com"},
		{name: "link_comparison_eq", file: "testdata/hover/multiline.cel", line: 0, char: 2, contains: "celbyexample.com/comparison/#equality", desc: "'==' links to celbyexample.com"},
		{name: "link_comparison_ne", file: "testdata/hover/multiline.cel", line: 1, char: 2, contains: "celbyexample.com/comparison/#equality", desc: "'!=' links to celbyexample.com"},
		{name: "link_comparison_gt", file: "testdata/hover/operators.cel", line: 0, char: 2, contains: "celbyexample.com/comparison/#ordering", desc: "'>' links to celbyexample.com"},
		{name: "link_comparison_lt", file: "testdata/hover/operators.cel", line: 0, char: 11, contains: "celbyexample.com/comparison/#ordering", desc: "'<' links to celbyexample.com"},
		{name: "link_comparison_gte", file: "testdata/hover/multiline.cel", line: 2, char: 2, contains: "celbyexample.com/comparison/#ordering", desc: "'>=' links to celbyexample.com"},
		{name: "link_comparison_lte", file: "testdata/hover/multiline.cel", line: 3, char: 2, contains: "celbyexample.com/comparison/#ordering", desc: "'<=' links to celbyexample.com"},
		{name: "link_arithmetic_plus", file: "testdata/hover/arithmetic.cel", line: 0, char: 3, contains: "celbyexample.com/arithmetic/", desc: "'+' links to celbyexample.com"},
		{name: "link_arithmetic_multiply", file: "testdata/hover/arithmetic.cel", line: 0, char: 7, contains: "celbyexample.com/arithmetic/", desc: "'*' links to celbyexample.com"},
		{name: "link_arithmetic_divide", file: "testdata/hover/arithmetic.cel", line: 0, char: 11, contains: "celbyexample.com/arithmetic/", desc: "'/' links to celbyexample.com"},
		{name: "link_arithmetic_modulo", file: "testdata/hover/arithmetic.cel", line: 0, char: 15, contains: "celbyexample.com/arithmetic/", desc: "'%' links to celbyexample.com"},
		{name: "link_in_operator", file: "testdata/hover/in_operator.cel", line: 0, char: 4, contains: "celbyexample.com/collections/#membership-and-access", desc: "'in' links to celbyexample.com"},
		{name: "link_ternary", file: "testdata/hover/ternary.cel", line: 0, char: 6, contains: "celbyexample.com/ternary/", desc: "'?:' links to celbyexample.com"},
		{name: "link_macro_all", file: "testdata/hover/macros.cel", line: 0, char: 10, contains: "celbyexample.com/all/", desc: "'all' macro links to celbyexample.com"},
		{name: "link_macro_has", file: "testdata/hover/has_macro.cel", line: 0, char: 0, contains: "celbyexample.com/has/", desc: "'has' macro links to celbyexample.com"},
		{name: "link_macro_exists_one", file: "testdata/hover/exists_one.cel", line: 0, char: 10, contains: "celbyexample.com/exists-one/", desc: "'exists_one' macro links to celbyexample.com"},
		{name: "link_macro_map", file: "testdata/hover/map_macro.cel", line: 0, char: 10, contains: "celbyexample.com/map-macro/", desc: "'map' macro links to celbyexample.com"},
		{name: "link_macro_exists", file: "testdata/hover/more_macros.cel", line: 0, char: 10, contains: "celbyexample.com/exists/", desc: "'exists' macro links to celbyexample.com"},
		{name: "link_macro_filter", file: "testdata/hover/more_macros.cel", line: 0, char: 41, contains: "celbyexample.com/filter/", desc: "'filter' macro links to celbyexample.com"},
		{name: "link_startswith", file: "testdata/hover/methods.cel", line: 0, char: 8, contains: "celbyexample.com/strings/#substring-search", desc: "'startsWith' links to celbyexample.com"},
		{name: "link_contains", file: "testdata/hover/methods.cel", line: 0, char: 38, contains: "celbyexample.com/strings/#substring-search", desc: "'contains' links to celbyexample.com"},
		{name: "link_endswith", file: "testdata/hover/more_methods.cel", line: 0, char: 14, contains: "celbyexample.com/strings/#substring-search", desc: "'endsWith' links to celbyexample.com"},
		{name: "link_matches", file: "testdata/hover/more_methods.cel", line: 0, char: 44, contains: "celbyexample.com/strings/#regular-expressions", desc: "'matches' links to celbyexample.com"},
		{name: "link_size", file: "testdata/hover/functions.cel", line: 0, char: 1, contains: "celbyexample.com/strings/#size", desc: "'size' links to celbyexample.com"},
		{name: "link_type_conv_int", file: "testdata/hover/functions.cel", line: 0, char: 17, contains: "celbyexample.com/type-conversions/#numeric-conversions", desc: "'int' links to celbyexample.com"},
